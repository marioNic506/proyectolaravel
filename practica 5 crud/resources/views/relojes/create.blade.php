...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('relojes.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="material_correa" name="material_correa" required>
            </div>
            <div class="form-group">
                <label for="resistencia_agua">Resistencia al Agua (metros):</label>
                <input type="number" class="form-control" id="resistencia_agua" name="resistencia_agua" required>
            </div>
            <button type="submit" class="btn btn-primary">Crear Reloj</button>
